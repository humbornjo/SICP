...
; When using cond to derive if clause. Because of the applicative
; nature of lisp, all the args of derived-if will be eval-ed on
; applied. Which lead to a infinite loop.
